...
Our phenotype of interest is educational attainment, defined as 'years of education'. EA is provided on a likert scale from 1-10, with higher values suggesting a greater number of years of education. We can find this in the masterDB.Rdata file which can found on datastore @/exports/igmm/GenScotDepression/data/genscot/phenotypes/masterDB.Rdata  
...
A. oEA ~ oPRS *This model captures direct GE*  
B. oEA ~ oPRS + mPRS + pPRS *This model captures both direct and indirect GE*  
  
C. oEA ~ oPRS + mEA + pEA  
D. oEA ~ oPRS + mEA + pEA + mPRS + pPRS  
...
Simple model  
![.](./EducationResults/Slide5.PNG)

Extended (Restricted) model   
![.](./EducationResults/Slide6.PNG)

Extended model  
![.](./EducationResults/Slide7.PNG)
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs.csv", row.names=F, quote=F)
...
pEA_res ~ g*peaPRS_0.05+pAGE
mEA_res ~ h*meaPRS_0.05+mAGE
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs.csv", row.names=F, quote=F)
```

![.](./EducationResults/Slide8.PNG)
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs_fm.csv", row.names=F, quote=F)
...
#mediator
eaPRS_0.05 ~ a*meaPRS_0.05
eaPRS_0.05 ~ d*peaPRS_0.05 
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs_fm.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs_fm.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs_nosib.csv", row.names=F, quote=F)
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs_nosib.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs_nosib.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs_matduo.csv", row.names=F, quote=F)
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs_matduo.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs_matduo.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "eaPRS_0.05_pa_m1_bs_patduo.csv", row.names=F, quote=F)
...
write.csv(extended_model, "eaPRS_0.05_pa_m2_bs_patduo.csv", row.names=F, quote=F)
...
# indirect effects (a*b, d*b)db := 0.5*b
gi := g*i
...
write.csv(extended_restricted_model, "eaPRS_0.05_pa_m3_bs_patduo.csv", row.names=F, quote=F)
```
