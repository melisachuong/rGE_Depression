...
write.csv(extended_restricted_model, "heiPRS_0.05_pa_m3_bs.csv", row.names=F, quote=F)
```
...
# mediator
heiPRS_0.05 ~ a*mheiPRS_0.05
heiPRS_0.05 ~ d*pheiPRS_0.05
HEIGHT ~ b*heiPRS_0.05
...
write.csv(extended_restricted_model, "heiPRS_0.05_pa_m3_bs_fm.csv", row.names=F, quote=F)
```
...
write.csv(extended_restricted_model, "heiPRS_0.05_pa_m3_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "heiPRS_0.05_pa_m3_bs_nosib.csv", row.names=F, quote=F)
```
...
write.csv(extended_restricted_model, "heiPRS_0.05_pa_m3_bs_matduo.csv", row.names=F, quote=F)
```
...
write.csv(extended_restricted_model, "heiPRS_0.05_pa_m3_bs_patduo.csv", row.names=F, quote=F)
```
