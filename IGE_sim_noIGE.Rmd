...
ggsave(file = "Simulations_PA_Figures_manuscript/am_rGE_pa_manuscript.png", width = 10, height = 6)
ggsave(file = "Simulations_PA_Figures_manuscript/am_rGE_pa_manuscript.svg", width = 10, height = 6)
```