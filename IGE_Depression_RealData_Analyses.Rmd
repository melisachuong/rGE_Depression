...
Our main phenotype of interest is depression. I use the General Health Questionnaire, which is used by psychiatrist for diagnoses of non-psychotic and minor psychiatric disorders. The GHQ-28 has been administered to GS participants and explores general psychological distress. The questionnaire is made up of 4 sections exploring anxiety & insomnia, somatic symptoms, social dysfunction and severe depression.  
I will use the total scores as psychological distress, as well as, focus on the severe depression questions to explore specifically on depression. Important to note that the whole questionnaire is validated, however, the severe depression qs on their own are not.  
...
Currently, PRSs informed by SNPs exceeding the genome-wide p-value threshold of 0.5 accounts for the greatest amount of variance in comparison to the other PRSs.  

Important to note that the depression PRS only accounts for (max) 1.3% of the variance in GHQ Depression and (max) 1.89% of the variance in GHQ Total. PRSs informed using SNPs with association p values <0.5 account for the greatest variance.  
We will use the PRSs informed using SNPs with association p values <0.05.  
...
Depression PRS - GHQ Depression summary
```{r, eval=FALSE}
...
Depression PRS - GHQ Total summary
```{r, eval=FALSE}
...
A. oDEP ~ oPRS *This model captures direct GE*  
B. oDEP ~ oPRS + mPRS + pPRS *This model captures both direct and indirect GE*  
  
C. oDEP ~ oPRS + mDEP + pDEP  
D. oDEP ~ oPRS + mDEP + pDEP + mPRS + pPRS  
...
![.](./DepressionResults/Slide6.PNG)  

Results can be found in the supplementary materials sheet 3
...
![.](./DepressionResults/Slide7.PNG)

Extended (Restricted) model   

![.](./DepressionResults/Slide8.PNG)

Extended model  

![.](./DepressionResults/Slide9.PNG)
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs.csv", row.names=F, quote=F)
...
pGHQT_res ~ g*pdepPRS_0.05+pAGE
mGHQT_res ~ h*mdepPRS_0.05+mAGE

GHQTotal ~ i*pGHQT_res
GHQTotal ~ j*mGHQT_res
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs.csv", row.names=F, quote=F)
```

![.](./DepressionResults/Slide10.PNG)  
...
# mediator
depPRS_0.05 ~ a*mdepPRS_0.05
depPRS_0.05 ~ d*pdepPRS_0.05
GHQTotal ~ b*depPRS_0.05
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs_fm.csv", row.names=F, quote=F)
...
# total effects 
total_mum := c + (a*b) + (h*j) ###### THIS IS WHAT I HAVE ADDED - NOT SURE IF ITS RIGHT THO #####
total_dad := f + (d*b) + (g*i) ###### THIS IS WHAT I HAVE ADDED - NOT SURE IF ITS RIGHT THO #####
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs_fm.csv", row.names=F, quote=F)
...
# total effects 
total_mum := (a*b) + (h*j) ###### THIS IS WHAT I HAVE ADDED - NOT SURE IF ITS RIGHT THO #####
total_dad := (d*b) + (g*i) ###### THIS IS WHAT I HAVE ADDED - NOT SURE IF ITS RIGHT THO #####
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs_fm.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs_FEMALE.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs_MALE.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs_nosib.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs_nosib.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs_nosib.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs_matduo.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs_matduo.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs_matduo.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQT_0.05_pa_m1_bs_patduo.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQT_0.05_pa_m2_bs_patduo.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQT_0.05_pa_m3_bs_patduo.csv", row.names=F, quote=F)
```
...
GHQDepression ~ f*pdepPRS_0.05             

# mediator
depPRS_0.05 ~ 0.5*mdepPRS_0.05
depPRS_0.05 ~ 0.5*pdepPRS_0.05
GHQDepression ~ b*depPRS_0.05
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs.csv", row.names=F, quote=F)
...
pGHQD_res ~ g*pdepPRS_0.05+pAGE
mGHQD_res ~ h*mdepPRS_0.05+mAGE

GHQDepression ~ i*pGHQD_res
GHQDepression ~ j*mGHQD_res
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs.csv", row.names=F, quote=F)
```

![.](./DepressionResults/Slide11.PNG)
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs_fm.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs_fm.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs_fm.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs_FEMALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs_FEMALE.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs_MALE.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs_MALE.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs_nosib.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs_nosib.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs_nosib.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs_matduo.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs_matduo.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs_matduo.csv", row.names=F, quote=F)
```
...
write.csv(simple_model, "depPRS_GHQD_0.05_pa_m1_bs_patduo.csv", row.names=F, quote=F)
...
write.csv(extended_model, "depPRS_GHQD_0.05_pa_m2_bs_patduo.csv", row.names=F, quote=F)
...
write.csv(extended_restricted_model, "depPRS_GHQD_0.05_pa_m3_bs_patduo.csv", row.names=F, quote=F)
```
